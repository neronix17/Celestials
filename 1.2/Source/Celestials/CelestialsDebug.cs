...
namespace Celestials
{
    ...
    {
        [DebugAction("Celestials", "Make Celestial", actionType = DebugActionType.ToolMapForPawns, allowedGameStates = AllowedGameStates.PlayingOnMap)]
        ...
        [DebugAction("Celestials", "Make Mortal", actionType = DebugActionType.ToolMapForPawns, allowedGameStates = AllowedGameStates.PlayingOnMap)]
